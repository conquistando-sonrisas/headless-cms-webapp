...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ConquiKid: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    FormularioType: Schema.Attribute.Enumeration<
      ['DONACION', 'REGISTRO-CARRERA']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'DONACION'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    NosotrosDescripcion: Schema.Attribute.Text;
